...
oo::define Config method save {} {
    ...
    try {
        ...
        ini::set $ini General LastFilename [my last_filename]
        ini::commit $ini
    } finally {
        ini::close $ini
    }
...
oo::define Config method last_filename {} { return $LastFilename }
...
oo::define Config method to_string {} {
    return "Config filename=$Filename blinking=$Blinking\
        scaling=[tk scaling] geometry=$Geometry last_filename=$LastFilename"
}
